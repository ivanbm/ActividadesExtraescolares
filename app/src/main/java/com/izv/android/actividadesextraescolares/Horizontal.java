...
public class Horizontal extends Activity {
    ...
    public void anadirHor(View v){
        ...
        Actividad a = new Actividad(obtenerIdProfesor(), tip, fi + " "+hi, ff + " "+hf, li, lf, des, "manolito");
    ...
    private class PostRestful extends AsyncTask<ParametrosPost, Void, String> {
        ...
        protected void onPostExecute(String r) {
            ...
            Toast.makeText(Horizontal.this, r, Toast.LENGTH_SHORT).show();
